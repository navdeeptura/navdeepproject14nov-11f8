[navdeepproject14nov-11f8] Operating Details
====================================

Generated On: 2024-11-14 17:23:44 UTC
...
.. important::
   ...
   **not be valid if your [navdeepproject14nov-11f8] container is NOT running**.

.. tip::
   You must have your [navdeepproject14nov-11f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34161  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='navdeeptura'  \-\-env DOCKERUSERNAME='navdeeptura'  \-\-env MQTTUSERNAME='turanavdeep'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   navdeeptura/navdeepproject14nov-11f8-amd64 (https://hub.docker.com/r/navdeeptura/navdeepproject14nov-11f8-amd64)
...
.. important::
   docker run -d -p 52215:52215 -p 36239:36239 -p 56731:56731 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=navdeepproject14nov-11f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-navdeepproject14nov-11f8 \-\-env GITUSERNAME=navdeeptura  \-\-env GITREPOURL=https://github.com/navdeeptura/raspberrypi \-\-env SOLUTIONEXTERNALPORT=52215  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=36239  \-\-env SOLUTIONVIPERVIZPORT=56731 \-\-env DOCKERUSERNAME='navdeeptura' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=34161 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='turanavdeep' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  navdeeptura/navdeepproject14nov-11f8-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - navdeeptura/navdeepproject14nov-11f8-amd64
...
[navdeepproject14nov-11f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/navdeeptura/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/navdeepproject14nov-11f8
...
.. important::
   https://navdeepproject14nov-11f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-navdeepproject14nov-11f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52215, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33787, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37217, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39617, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39323, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43515, HPDEHOST=127.0.1.1, HPDEPORT=35173, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44727

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7594-navdeepproject14nov-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov-11f8, python-preprocess-3491-navdeepproject14nov-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov-11f8, python-ai-4761-navdeepproject14nov-11f8,solution_preprocessing_ai_mqtt_dag-navdeepproject14nov-11f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
